...
public class LabelDelphiEntry {
    private Source source;
    private String field;
    private String value;

    public LabelDelphiEntry(Label label, String value) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LabelDelphiEntry)) return false;
        LabelDelphiEntry label = (LabelDelphiEntry) o;
